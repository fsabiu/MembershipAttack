...
class Explanator(ABC):
    def __init__(self, dataset, class_name, categorical_features, categorical_names, n_classes, black_box):
        # Data and target
...
class LimeExplanator(Explanator):
    def __init__(self, dataset, class_name, categorical_features, categorical_names, n_classes, black_box):
        ...
        self.explainer = lime.lime_tabular.LimeTabularExplainer(
            ...
            feature_names = self.dataset.columns.remove(self.class_name),
